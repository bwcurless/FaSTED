...
\begin{tikzpicture}
		\newcommand\tileSpacing{1}
		\newcommand\tileDim{1.5}
				...
				% inner square rasterized chunks
										...
										\foreach \row in {0, ..., \innerRange} {
														\foreach \col in {0, ..., \innerRange} {
																		...
																		\draw[style=fragment, draw=black] (TileUL) rectangle ++(\tileDim, -\tileDim) node[midway, font=\small, align=center] {Block\\ Tile\\ \tileIndex};
																		...
																		\tikzstyle arrow=[arrows= -{Stealth}, ultra thick, rounded corners= 5pt]
