...
\begin{tikzpicture}
	...
	\fill[style=fragment,fill=BFragmentColor] (0, 0) rectangle +(\fn, -\fk) node[style=matrixLabelStyle] {$Q_{\regf}$};
	...
	\fill[style=fragment,fill=DFragmentColor, xshift=0 cm, yshift=\dYShift cm] (0, 0) rectangle +(\fn, -\fm) node[style=matrixLabelStyle] {$A_{\regf}$};
...
\fill[style=fragment,fill=AFragmentColor, xshift=\aXShift cm, yshift=\aYShift cm] (0, 0) rectangle +(\fk, -\fm) node[style=matrixLabelStyle] {$P_{\regf}$};
